    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow space-y-6">
          <h1 className="text-2xl font-bold">Confirm your property details</h1>

          {/* BASIC INFO */}
          <div className="space-y-2">
            <p>
              <b>Name:</b> {state.PropertyName}
            </p>
            <p>
              <b>Type:</b> {state.propertyType}
            </p>
            <p>
              <b>Guests:</b> {state.guests}
            </p>
            <p>
              <b>Bedrooms:</b> {state.bedrooms}
            </p>
            <p>
              <b>Beds:</b> {state.beds}
            </p>
            <p>
              <b>Bathrooms:</b> {state.bathrooms}
            </p>
          </div>
          ...
          <div className="space-y-1">
            ...
            <p>
              {state.landmark}, {state.locality}
            </p>
            <p>
              {state.city}, {state.state} – {state.pincode}
            </p>
            <p>{state.country}</p>
          </div>
          ...
          <div>
            <p>
              <b>Base Price:</b> ₹{state.basePrice}
            </p>
            <p>
              <b>Weekend Price:</b> ₹{state.weekendPrice}
            </p>
          </div>
